...
class DslUserStoriesTest < ActionDispatch::IntegrationTest
  ...
  def test_buying_a_product
    aleks = regular_user
    aleks.get "/"
    aleks.is_viewing "index"
    aleks.buys_a @ruby_book
    aleks.has_a_cart_containing @ruby_book
    aleks.checks_out ALEKS_DETAILS
    aleks.is_viewing "index"
    check_for_order ALEKS_DETAILS, @ruby_book
  end
